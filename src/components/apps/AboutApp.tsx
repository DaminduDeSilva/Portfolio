          ...
          {steps.map((label, i) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={`ml-3 text-sm transition-colors ${isActive ? "text-white font-bold" : "text-white/70 group-hover:text-white"}`}
                >
                  {label}
                </span>
              </li>
  ...
  const renderContent = () => {
    switch (step) {
        ...
        return (
          <div className="text-gray-800">
            ...
            <div className="space-y-4 leading-relaxed bg-gray-50 p-4 border border-gray-200 rounded">
              <p>
                Hello! I am an ambitious undergraduate pursuing my BSc (Hons) in
                Computer Science & Engineering at the University of Moratuwa.
              </p>
              <p>
                I specialize in Cybersecurity, Full-Stack Development, and
                System Architecture. I have a deep passion for open-source
                software, Linux environments, and creating tools that solve
                complex problems efficiently and securely.
              </p>
            </div>
          </div>
        );
      ...
      case 3: // EDUCATION
        return (
          <div className="text-gray-800">
            <h2 className="text-2xl font-bold mb-4 text-[#E95420]">
              Education
            </h2>
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-4 border border-gray-200 rounded">
                ...
                <p className="text-gray-500 text-sm mt-1">
                  Physical Science Stream - 3 As (Distinction)
                </p>
                <p className="text-gray-500 text-sm mt-1 font-bold">
                  Z-score: 2.3958 | Island Rank: 262
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 p-4 border border-gray-200 rounded">
                <p className="font-bold text-lg border-b pb-2 mb-2">
                  Intern DevOps Engineer (Dec 2025 - May 2026)
                </p>
                ...
                <ul className="list-disc ml-5 space-y-2 text-gray-700">
                  <li>
                    Worked with real production application hosting and
                    deployment.
                  </li>
                  <li>
                    Managed infrastructure provisioning and firewall operations.
                  </li>
                </ul>
              </div>
            </div>

            <h2 className="text-2xl font-bold mt-6 mb-4 text-[#E95420]">
              Volunteering
            </h2>
            <div className="space-y-4">
              <div className="bg-gray-50 p-3 border border-gray-200 rounded">
                <p className="font-bold text-md text-gray-900">
                  Cyber Rush Dev Team (2025)
                </p>
                <p className="text-gray-600 text-sm">
                  Designed interactive cryptography CTF challenges.
                </p>
              </div>
              <div className="bg-gray-50 p-3 border border-gray-200 rounded">
                <p className="font-bold text-md text-gray-900">
                  CSE 40 Logistics Committee (2025)
                </p>
                <p className="text-gray-600 text-sm">
                  Organized the 40th anniversary of UoM CSE Dept.
                </p>
              </div>
              <div className="bg-gray-50 p-3 border border-gray-200 rounded">
                <p className="font-bold text-md text-gray-900">
                  IESL Robogames (2024/2025)
                </p>
                <p className="text-gray-600 text-sm">
                  Member of logistics team for Sri Lanka's largest robotics
                  competition.
                </p>
              </div>
            </div>
      ...
      case 5: // PROJECTS
        return (
          <div className="text-gray-800 flex flex-col h-full bg-white">
            <h2 className="text-2xl font-bold mb-4 text-[#E95420] shrink-0">
              Projects Portfolio
            </h2>
              ...
              {projectTab === "cyber" && (
                <div className="space-y-4 animate-in fade-in duration-300">
                  <div className="bg-gray-50 p-4 border border-gray-200 rounded hover:border-[#E95420]/30 transition-colors">
                    ...
                    <p className="text-xs text-[#E95420] font-mono mb-2 bg-[#E95420]/10 inline-block px-2 py-1 rounded">
                      Python • RustScan • Nmap • Gemini API
                    </p>
                    <p className="text-gray-700 text-sm mb-3">
                      Passive & active recon tool with AI LLM wordlist
                      generation, CDN tracking, and API detection.
                    </p>
                    <a
                      href="https://github.com/DaminduDeSilva/web-domain-scanner.git"
                      target="_blank"
                  ...
                  <div className="bg-gray-50 p-4 border border-gray-200 rounded hover:border-[#E95420]/30 transition-colors">
                    ...
                    <p className="text-xs text-[#E95420] font-mono mb-2 bg-[#E95420]/10 inline-block px-2 py-1 rounded">
                      Python (Flask) • AES • ECDSA
                    </p>
                    <p className="text-gray-700 text-sm mb-3">
                      Simulated challenge with AES-encrypted passwords & ECDSA
                      private key recovery via nonce reuse attack patterns.
                    </p>
                    <a
                      href="https://github.com/DaminduDeSilva/CTF-Challenge-Cryptography"
                      target="_blank"
                      className="text-blue-600 text-sm hover:underline font-medium"
                    >
                      View Source →
                  ...
                  <div className="bg-gray-50 p-4 border border-gray-200 rounded hover:border-[#E95420]/30 transition-colors">
                    <h3 className="font-bold text-lg text-gray-900">
                      Android App Security Analysis - InsecureBankv2
                    </h3>
                    <p className="text-xs text-[#E95420] font-mono mb-2 bg-[#E95420]/10 inline-block px-2 py-1 rounded">
                      Burp Suite • JADX • APKTool
                    </p>
                    <p className="text-gray-700 text-sm mb-3">
                      OWASP Mobile security assessment finding insecure storage
                      and weak authentication mechanisms.
                    </p>
                    <a
                      href="https://bit.ly/android-security-analysis"
                      target="_blank"
                      className="text-blue-600 text-sm hover:underline font-medium"
                    >
                      View Report →
              ...
              {projectTab === "devops" && (
                <div className="space-y-4 animate-in fade-in duration-300">
                  <div className="bg-gray-50 p-4 border border-[#E95420]/40 rounded hover:border-[#E95420] transition-colors relative overflow-hidden shadow-sm">
                    <div className="absolute top-0 right-0 bg-[#E95420] text-white text-[10px] font-bold px-3 py-1 rounded-bl-lg tracking-wider">
                      FEATURED
                    </div>
                    <h3 className="font-bold text-lg text-gray-900 pr-16">
                      CI-Insight: Unified CI/CD Intelligence
                    </h3>
                    <p className="text-xs text-[#E95420] font-mono mb-2 bg-[#E95420]/10 inline-block px-2 py-1 rounded mt-2">
                      Next.js 16 • Tailwind CSS • App Router
                    </p>
                    <p className="text-gray-700 text-sm mb-3">
                      An AI-powered CI/CD intelligence platform that unifies
                      pipeline data, enables AI-driven security analysis, and
                      supports DevSecOps workflows through a cinematic,
                      interactive dashboard framework.
                    </p>
                    <a
                      href="https://github.com/Dark-Side-Mora/ci-insight-presentation"
                      target="_blank"
                  ...
                  <div className="bg-gray-50 p-4 border border-gray-200 rounded hover:border-[#E95420]/30 transition-colors">
                    ...
                    <p className="text-xs text-[#E95420] font-mono mb-2 bg-[#E95420]/10 inline-block px-2 py-1 rounded mt-1">
                      Sri Lanka Telecom • Infrastructure • Monitoring
                    </p>
                    <p className="text-gray-700 text-sm mb-0">
                      Engineered a dedicated monitoring service tailored to
                      track operations and visualize core infrastructure
                      health/analytics for the internal MySLT dashboard
                      environment.
                    </p>
                  </div>
                </div>
              ...
              {projectTab === "fullstack" && (
                <div className="space-y-4 animate-in fade-in duration-300">
                  <div className="bg-gray-50 p-4 border border-gray-200 rounded hover:border-[#E95420]/30 transition-colors">
                    ...
                    <p className="text-xs text-[#E95420] font-mono mb-2 bg-[#E95420]/10 inline-block px-2 py-1 rounded mt-1">
                      Node.js • Supabase • React.js
                    </p>
                    <p className="text-gray-700 text-sm mb-3">
                      Complete multi-tenant platform connecting individual
                      salons & customers seamlessly with secure OAuth
                      authentication and scheduling.
                    </p>
                    <a
                      href="https://github.com/Vivora-Solutions"
                      target="_blank"
                      className="text-blue-600 text-sm hover:underline font-medium"
                    >
                      View Source →
                  ...
                  <div className="bg-gray-50 p-4 border border-gray-200 rounded hover:border-[#E95420]/30 transition-colors">
                    ...
                    <p className="text-xs text-[#E95420] font-mono mb-2 bg-[#E95420]/10 inline-block px-2 py-1 rounded mt-1">
                      Spring Boot • Angular • Hyperledger Fabric
                    </p>
                    <p className="text-gray-700 text-sm mb-3">
                      Decentralized health records platform utilizing structural
                      blockchain integrity paired with AI diagnosis models and
                      WebRTC live streaming.
                    </p>
                    <a
                      href="https://github.com/DaminduDeSilva/Healthcare-Appointment-and-Management-System.git"
                      target="_blank"
                      className="text-blue-600 text-sm hover:underline font-medium"
                    >
                      View Source →
                  ...
                  <div className="bg-gray-50 p-4 border border-gray-200 rounded hover:border-[#E95420]/30 transition-colors">
                    ...
                    <p className="text-gray-700 text-sm mb-3">
                      End-to-end global logistics dashboard capable of
                      orchestrating complex railway and trucking transit
                      operations simultaneously from one hub.
                    </p>
                    <a
                      href="https://github.com/DaminduDeSilva/Supply-Chain-Management-System"
                      target="_blank"
                      className="text-blue-600 text-sm hover:underline font-medium"
                    >
                      View Source →
            ...
            <div className="bg-gray-50 p-4 border border-gray-200 rounded space-y-3 shadow-inner">
              <div className="flex items-start">
                ...
                <p className="text-gray-800">
                  <b>Cybershield 4.0 Finalist</b> – 2025, organized by IEEE
                  Computer Society of SLIIT in collaboration with Hashx
                </p>
              </div>
              <div className="flex items-start">
                <FiCheckCircle className="text-[#E95420] mt-1 shrink-0 mr-3" />
                <p className="text-gray-800">
                  <b>CryptX Finalist</b> – 2025, organized by Faculty of
              ...
              <div className="flex items-start">
                ...
                <p className="text-gray-800">
                  ...
                  – 2026, organized by Rotaract Club of University of Moratuwa
                </p>
              </div>
              <div className="flex items-start">
                <FiCheckCircle className="text-[#E95420] mt-1 shrink-0 mr-3" />
                <p className="text-gray-800">
                  <b>GENZIPHER Hackathon 1st Runner Up</b> – 2026, organized by
              ...
              <div className="flex items-start">
                <FiCheckCircle className="text-[#E95420] mt-1 shrink-0 mr-3" />
                <p className="text-gray-800">
                  <b>Capture The Flag (CTF) Competition 1st Runner Up</b> –
                  2025, organized by CICRA Holdings / Daily FT
                </p>
              </div>
              <div className="flex items-start">
                <FiCheckCircle className="text-[#E95420] mt-1 shrink-0 mr-3" />
                <p className="text-gray-800">
                  <b>Cypher 3.0 - Inside a Hacker's Mind</b> – 2025, organized
                  by IEEE Student Branch of KDU
                </p>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-300">
                ...
                <p className="text-gray-700 text-sm flex items-center">
                  <span className="text-[#E95420] font-bold mr-2">•</span>Linux
                  Command Line: From Zero to Hero (Udemy)
                </p>
                <p className="text-gray-700 text-sm flex items-center mt-1">
                  <span className="text-[#E95420] font-bold mr-2">•</span>
        ...
        return (
          <div className="flex flex-col items-center justify-center h-full text-center text-gray-800">
            ...
            <p className="text-gray-600">
              The environment is now ready. Click <b>Finish</b> to explore the
              portfolio!
            </p>
          </div>
        );
