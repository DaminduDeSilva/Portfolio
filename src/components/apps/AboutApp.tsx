            ...
            <div className="flex gap-6 mb-6">
              <div className="flex-1">
                <p className="mb-4 text-lg leading-relaxed">
                  This wizard will install <b>Damindu De Silva's Portfolio</b>{" "}
                  on your computer. It is recommended that you grab a coffee
                  before continuing.
                </p>
                <p className="mb-4 text-lg leading-relaxed">
                  I am an innovative Undergraduate Software Engineer currently
            ...
            <div className="grid grid-cols-2 gap-4 mt-2">
              ...
              <div className="bg-white p-4 border border-gray-300 rounded-lg shadow-sm flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    CTF Player, Pentesting & Network Security
                  </p>
                </div>
              </div>
            </div>
        ...
        return (
          <div className="flex flex-col h-full animate-fade-in text-gray-800">
            ...
            <p className="mb-3 text-base font-medium text-gray-700">
              Detailed academic and professional summary:
            </p>
            <div className="flex-1 overflow-y-auto mb-6 bg-white border border-gray-300 p-6 text-base rounded-md shadow-inner space-y-6">
              <section>
                <h3 className="font-bold text-lg mb-2 text-[#E95420] flex items-center border-b pb-1">
                  <span className="bg-[#E95420] text-white w-6 h-6 rounded-full inline-flex items-center justify-center text-xs mr-2">
                    1
                  </span>{" "}
                  Education
                </h3>
                <div className="ml-8 space-y-4">
                  <div>
                    ...
                    <p className="text-[#E95420] font-bold mt-1 inline-block bg-[#fff3ef] px-2 py-0.5 rounded border border-[#ffd8cc]">
                      Current GPA: 3.5 / 4.0
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-700 font-medium">
                      Maliyadeva College Kurunegala (2021)
                    </p>
                    <p className="text-gray-600 text-sm italic">
                      3A's - Physical Science Stream | District Rank: 22 |
                      Island Rank: 262
                    </p>
                  </div>
                </div>
              ...
              <section>
                ...
                <ul className="ml-12 list-disc space-y-2 text-gray-700">
                  <li>
                    <b>Ubuntu OS Portfolio</b> - A fully functional web-based
                    desktop environment.
                  </li>
                  <li>
                    <b>CyberGuard AI</b> - Machine learning model for network
                    intrusion detection.
                  </li>
                  <li>
                    <b>DevFlow</b> - Collaborative task management system for
                    engineering teams.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="ml-12 list-disc space-y-2 text-gray-700">
                  ...
                  <li>
                    Dean's List for Academic Excellence (Semester 1, 2, 4)
                  </li>
                </ul>
              </section>
            </div>
          ...
          <div className="flex flex-col h-full animate-fade-in text-gray-800">
              ...
              <div className="flex justify-between text-base font-bold text-gray-800">
                <span className="flex items-center">
                  ...
                  {progress < 20
                    ? "Initializing..."
                    : progress < 40
                      ? "Configuring Frontend (React/Next)..."
                      : progress < 60
                        ? "Linking Backend (Node/Go)..."
                        : progress < 85
                          ? "Securing Environment (Cyber)..."
            ...
            <div className="mt-6 bg-[#1e1e1e] text-[#4af626] font-mono text-sm p-4 rounded-md h-40 overflow-y-auto border-2 border-gray-700 shadow-2xl custom-scrollbar">
              <div className="text-gray-500 text-xs mb-1">
                # Ubuntu 24.04 (Noble Numbat) dpkg logs
              </div>
              {progress > 5 && <div>&gt; Reading package lists... Done</div>}
              {progress > 15 && (
                <div>&gt; Unpacking react-dom (18.2.0-stable)... 100%</div>
              )}
              {progress > 25 && (
                <div>&gt; Setting up tailwindcss-jit-engine... OK</div>
              )}
              {progress > 35 && (
                <div>&gt; Processing: Moratuwa-CSE-Core-Concept... [PASS]</div>
              )}
              {progress > 45 && (
                <div>
                  &gt; Fetching project-assets from /var/cache/apt/archives...
                </div>
              )}
              {progress > 55 && (
              ...
              {progress > 65 && (
                <div>&gt; Linking cybersecurity-toolkit to /usr/bin/ctf</div>
              )}
              {progress > 75 && (
                <div>&gt; Compiling Damindu-Profile-Data.cpp... Done</div>
              )}
              {progress > 85 && (
                <div>&gt; Creating symlinks for portfolio-os...</div>
              )}
              {progress >= 100 && (
                <div className="text-yellow-400 font-bold animate-pulse">
                  &gt; SUCCESS: Damindu De Silva has been installed!
                </div>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-col h-full animate-fade-in text-gray-800">
            ...
            <div className="bg-white border border-gray-300 p-6 rounded-xl shadow-sm space-y-4">
              <p className="text-lg leading-relaxed text-gray-700">
                ...
                <b>Damindu De Silva's Portfolio System</b>. All project modules
                and tech-stack dependencies were successfully deployed.
              </p>
            ...
            <p className="mt-6 text-lg font-medium text-gray-800">
              You can now launch applications from the taskbar to explore his
              work.
            </p>
